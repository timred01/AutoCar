        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <a href="<?= base_url('customer/dashboard') ?>">
                            <img src="<?= base_url('assets/assets_stisla'); ?>/assets/img/logo.png" alt="logo"
                                width="80" class="shadow-light rounded-circle mb-4 mt-2">
                        </a>
                        <h4 class="text-dark font-weight-bold">SELAMAT DATANG</h4>
                        <p class="text-muted">Sebelum memulai, Anda harus masuk atau mendaftar jika Anda belum memiliki
                            akun.</p>

                        <?= $this->session->flashdata('pesan') ?>

                        <form method="POST" action="<?= base_url('auth/process') ?>" id="loginform" autocomplete="off"
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
                    data-background="<?= base_url('assets/assets_stisla'); ?>/assets/img/unsplash/login-bg.jpg">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold text-gradient">AUTO CAR</h1>
                                <h5 class="font-weight-normal text-muted-transparent">Cawang, Jakarta Timur, Indonesia
                                </h5>
                            </div>
                            Photo by <a class="text-light bb" target="_blank"
                                href="https://unsplash.com/photos/_TFu0wxWNWE">Josh Hild</a> on <a class="text-light bb"
