...
<head>
    ...
    <!-- Lightbox -->
    <link rel="stylesheet" href="<?= base_url('assets/assets_stisla') ?>/assets/css/magnific-popup.css">
    <script src="https://code.jquery.com/jquery-3.4.1.min.js"
        integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="<?= base_url('assets/assets_stisla') ?>/assets/js/jquery.magnific-popup.js">
</head>