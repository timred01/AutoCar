        ...
        <div class="container-fluid mt-4">
            <table class="table table-borderless">
                <tbody>
                    ...
                    <tr>
                        <td class="text-center pb-0">Jl. Dewi Sartika No.289, Cawang, Kramat jati, Kota Jakarta Timur
                            13630
                        </td>
                    </tr>
                    <tr class="pt-0">
                        <td class="text-center pt-0">Telp: 021-12345678 | WA: 0881-1234-56789 | Email: pesan@autocar.com
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    ...
                    <tr>
                        <?php
                            ...
                            ?>
                        <td colspan='3'>
                            <b>*Silahkan transfer Total Biaya Sewa ke 6666 6666 6666 6666 Bank BNI a/n KELOMPOK 2.
                                Maksimal tanggal <?= $batas_bayar ?>. <br>
                                Untuk konfirmasi pesanan silahkan ke halaman Riwayat Sewa. Adapun jika status pembayaran
                                & sewa 'Batal' maka transaksi tidak perlu dilanjutkan.</b>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
