                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="card card-primary">
                                <div class="p-car-thumbnails">
                                    <a class="car-hover"
                                        href="<?= base_url() . 'assets/upload/mobil/' . $mb->gambar ?>">
                                        <img src="<?= base_url() . 'assets/upload/mobil/' . $mb->gambar ?>"
                                            style="height: 300px; width: 540px">
                                    </a>
                                </div>
                                <div class="car-list-info without-bar">
                                    <h2><a
                                            href="<?= base_url('customer/dashboard/detail_mobil/') . $mb->id_mobil ?>"><?= $mb->merk ?></a>
                                    </h2>
                                    ...
                                    <a href="<?= base_url('customer/rental/tambah_rental/') . $mb->id_mobil ?>"
                                        class="btn btn-primary"><i class="fa fa-car text-success"></i> Sewa</a>
                                    <a href="<?= base_url('customer/dashboard/detail_mobil/') . $mb->id_mobil ?>"
                                        class="btn btn-primary"><i class="fa fa-search-plus"></i> Detail</a>
                                    <?php } else { ?>
