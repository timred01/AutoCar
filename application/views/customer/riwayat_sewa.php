        ...
        <div class="row">
            <div class="col-lg-12 m-auto">
                ...
                <div class="card shadow mt-4 mb-4">
                    ...
                    <div class="card-body">
                        <table class="table table-responsive table-hover table-striped table-bordered no-wrapper" id="data_table">
                            <thead>
                                <tr align="center">
                                    <th>No</th>
                                    <th>Nama</th>
                                    ...
                                    <tr align="center">
                                        ...
                                        <td>
                                            <?php if ($ts->status_pembayaran == 0) { ?>
                                                <span class='btn btn-sm btn-danger'><i class="fa fa-times"></i> Belum
                                                    Dibayar</span>
                                            <?php } elseif ($ts->status_pembayaran == 1) { ?>
                                                <span class='btn btn-sm btn-info'><i class="fa fa-info"></i> Menunggu
                                                    Konfirmasi</span>
                                            <?php } elseif ($ts->status_pembayaran == 2) { ?>
                                                <span class='btn btn-sm btn-success'><i class="fa fa-check"></i> Sudah
                                                    Dibayar</span>
                                            <?php } else { ?>
                                        ...
                                        <td>
                                            ...
                                            <?php  } else { ?>
                                                <span class='btn btn-sm btn-success'><i class="fa fa-check"></i> Mobil Telah
                                                    Dikembalikan</span>
                                            <?php  } ?>
                                        </td>
                                        <td>
