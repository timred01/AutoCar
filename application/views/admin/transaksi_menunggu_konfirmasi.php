                ...
                <table class="table table-hover table-striped table-bordered" id="data_table">
                    ...
                    <tbody>
                        ...
                        <tr align="center">
                            ...
                            <td>
                                <a class="popup"
                                    href="<?= base_url() . 'assets/upload/bukti_pembayaran/' . $ts->bukti_pembayaran ?>">
                                    <img width="80px"
                                        src="<?= base_url() . 'assets/upload/bukti_pembayaran/' . $ts->bukti_pembayaran ?>">
                                </a>
                            </td>
                            <td>
                                <a href="<?= base_url('admin/transaksi/konfirmasi_pembayaran/') . $ts->id_transaksi ?>"
                                    class="btn btn-sm btn-light tombol-konfirmasi"><i class="fas fa-check"></i></a>
                            </td>
                        </tr>
                        <?php endif ?>
                        <?php endforeach; ?>
